      ...
      <div className="relative isolate pt-14">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            <div className="flex">
              <div className="relative flex items-center gap-x-4 rounded-full bg-surface px-4 py-1 text-sm/6 text-text-muted ring-1 ring-border-card hover:ring-border-strong">
                <span className="font-semibold text-brand">We’re hiring</span>
                <span aria-hidden="true" className="h-4 w-px bg-brand-on/10" />
                <a href="#" className="flex items-center gap-x-1">
                  <span aria-hidden="true" className="absolute inset-0" />
                  See open positions
                  <ChevronRightIcon
                    aria-hidden="true"
                    className="-mr-2 size-5 text-text-muted"
                  />
                </a>
              </div>
            </div>
