    ...
    <div className="relative isolate overflow-hidden bg-surface py-24 sm:py-32">
      ...
      >
        <div
          ...
          className="aspect-801/1036 w-200.25 bg-linear-to-tr from-brand-soft to-brand opacity-30"
        />
      </div>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-xl/8 text-text">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12">
          <div className="relative lg:order-last lg:col-span-5">
            ...
            <figure className="border-l border-brand pl-8">
              <blockquote className="text-xl/8 font-semibold tracking-tight text-text">
                <p>
                  &quot;Vel ultricies morbi odio facilisi ultrices accumsan
                  donec lacus purus. Lectus nibh ullamcorper ac dictum justo in
              ...
              <figcaption className="mt-8 flex gap-x-4">
                <img
                  ...
                  className="mt-1 size-10 flex-none rounded-full bg-bg"
                />
                <div className="text-sm/6">
                  <div className="font-semibold text-text">
                    Brenna Goyette
                  </div>
                  <div className="text-text-muted">@brenna</div>
                </div>
              </figcaption>
            </figure>
          </div>
          <div className="max-w-xl text-base/7 text-text-muted lg:col-span-7">
            <p>
            ...
            <h2 className="mt-16 text-2xl font-bold tracking-tight text-text">
