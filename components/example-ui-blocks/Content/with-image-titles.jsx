    ...
    <div className="overflow-hidden bg-surface py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <div className="max-w-4xl">
          <p className="text-base/7 font-semibold text-brand">About us</p>
          <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-text sm:text-5xl">
            On a mission to empower remote teams
          </h1>
          <p className="mt-6 text-xl/8 text-balance text-text">
        ...
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
          <div className="lg:pr-8">
            <h2 className="text-2xl font-semibold tracking-tight text-pretty text-text">
              Our mission
            </h2>
            ...
            <p className="mt-8 text-base/7 text-text-muted">
          ...
          <div className="max-lg:mt-16 lg:col-span-1">
            ...
            <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
              <div className="flex flex-col gap-y-2 border-b border-dotted border-border pb-4">
                <dt className="text-sm/6 text-text-muted">Raised</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight text-text">
                  $<span>150</span>M
                </dd>
              </div>
              <div className="flex flex-col gap-y-2 border-b border-dotted border-border pb-4">
                <dt className="text-sm/6 text-text-muted">Companies</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight text-text">
                  <span>30</span>K
                </dd>
              </div>
              <div className="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-border max-sm:pb-4">
                <dt className="text-sm/6 text-text-muted">Deals Closed</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight text-text">
                  <span>1.5</span>M
                </dd>
              </div>
              <div className="flex flex-col gap-y-2">
                <dt className="text-sm/6 text-text-muted">Leads Generated</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight text-text">
                  <span>200</span>M
                </dd>
              </div>
