...
export default function Example() {
  return (
    <div className="bg-surface px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 text-text">
        <p className="text-base/7 font-semibold text-brand">Introducing</p>
        ...
        <div className="mt-10 max-w-2xl text-text-muted">
          <p>
          ...
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-text-muted">
            <li className="flex gap-x-3">
              <CheckCircleIcon
                aria-hidden="true"
                className="mt-1 size-5 flex-none text-brand"
              />
              <span>
            ...
            <li className="flex gap-x-3">
              ...
              />
              <span>
                <strong className="font-semibold text-text">Loops.</strong>{" "}
            ...
            <li className="flex gap-x-3">
              ...
              />
              <span>
                <strong className="font-semibold text-text">Events.</strong>{" "}
          ...
          <figure className="mt-10 border-l border-brand pl-9">
            ...
            <figcaption className="mt-6 flex gap-x-4">
              <img
                ...
                className="size-6 flex-none rounded-full bg-bg"
              />
        ...
        <figure className="mt-16">
          <img
            ...
            className="aspect-video rounded-xl bg-bg object-cover"
          />
          <figcaption className="mt-4 flex gap-x-2 text-sm/6 text-text-muted">
            <InformationCircleIcon
              aria-hidden="true"
              className="mt-0.5 size-5 flex-none text-text-muted"
            />
            Faucibus commodo massa rhoncus, volutpat.
          </figcaption>
        </figure>
        <div className="mt-16 max-w-2xl text-text-muted">
