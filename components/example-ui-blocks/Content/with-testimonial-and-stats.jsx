      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-4">
            <div className="relative overflow-hidden rounded-3xl bg-brand-on px-6 pt-64 pb-9 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
              <img
                alt=""
              ...
              />
              <div className="absolute inset-0 bg-brand-on mix-blend-multiply" />
              <div
                aria-hidden="true"
              ...
              >
                <div
                  ...
                  className="aspect-1097/845 w-274.25 bg-linear-to-tr from-brand-soft to-brand opacity-40"
                />
              </div>
              <figure className="relative isolate">
                ...
                <figcaption className="mt-6 text-sm/6 text-text-muted">
          ...
          <div>
            <div className="text-base/7 text-text lg:max-w-lg">
            ...
            <dl className="mt-10 grid grid-cols-2 gap-8 border-t border-gray-900/10 pt-10 sm:grid-cols-4">
              {stats.map((stat, statIdx) => (
                <div key={statIdx}>
                  <dt className="text-sm/6 font-semibold text-text-muted">
                    {stat.label}
                  </dt>
                  <dd className="mt-2 text-3xl/10 font-bold tracking-tight text-text">
                    {stat.value}
                  </dd>
                </div>
              ))}
            ...
            <div className="mt-10 flex">
              <a
                href="#"
                className="text-base/7 font-semibold text-brand hover:text-indigo-500"
              >
