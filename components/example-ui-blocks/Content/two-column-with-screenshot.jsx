    ...
    <div className="bg-surface py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <div className="mt-10 grid max-w-xl grid-cols-1 gap-8 text-base/7 text-text lg:max-w-none lg:grid-cols-2">
            <div>
              <p>
      ...
      <div className="relative overflow-hidden pt-16 lg:pt-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <img
            ...
            className="mb-[-12%] w-full rounded-xl shadow-2xl ring-1 ring-border-card"
          />
