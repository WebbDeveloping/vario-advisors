export default function Example() {
  return (
    <div className="relative bg-surface">
      <div className="relative h-80 overflow-hidden bg-brand md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2">
        <img
          alt=""
      ...
      <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="pr-6 pl-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pr-0 lg:pl-24 xl:pl-32">
          ...
          <p className="mt-2 text-4xl font-semibold tracking-tight text-text sm:text-5xl">
            We’re here to help
          </p>
