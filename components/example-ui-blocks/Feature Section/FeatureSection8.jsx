  ...
  return (
    <div className="bg-surface py-24">
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden bg-brand-on px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24">
          ...
          >
            <div
              ...
              className="aspect-1155/678 w-288.75 bg-linear-to-tr from-brand-soft to-brand opacity-25"
            />
          </div>
        </div>
      </div>
